...
class LayerZeroClient(BridgeClient):
    """Client for LayerZero bridge"""
    ...
    async def get_quote(
        ...
        """Get quote from LayerZero (mock implementation)"""
        ...
        try:
            ...
            bridge_fee = amount_float * 0.00035  # 0.035% fee
            gas_cost_source = 9.0
            gas_cost_dest = 0.3
